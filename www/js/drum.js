...
var tbDrum = document.getElementById('tb_drum');
var databaseRef = firebase.database().ref('product_drum/');
var rowIndex = 1;
...
databaseRef.once('value', function(snapshot) {
    snapshot.forEach(function(childSnapshot) {
        ...
        var row = tbDrum.insertRow(rowIndex);
    ...
    var table = document.getElementById("tb_drum");
    ...
    function delete_product(){
        var uid = document.getElementById('uid').value;
        firebase.database().ref().child('/product_drum/' + uid).remove();
