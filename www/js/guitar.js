...
var tbGuitar = document.getElementById('tb_guitar');
var databaseRef = firebase.database().ref('product_guitar/');
var rowIndex = 1;
...
databaseRef.once('value', function(snapshot) {
    snapshot.forEach(function(childSnapshot) {
        ...
        var row = tbGuitar.insertRow(rowIndex);
    ...
    var table = document.getElementById("tb_guitar");
    ...
    function update_product(){
        ...
        var updates = {};
        updates['/product_guitar/' + uid] = data;
    ...
    function delete_product(){
        var uid = document.getElementById('uid').value;
        firebase.database().ref().child('/product_guitar/' + uid).remove();
